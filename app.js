...
const solarSystem = [
    ...
    console.log('Jupiter\'s moon : ',solarSystem[4].moons)
    console.log("*****************************************************************");

    // 2. Print the name of Neptune's moon "Nereid" to the console.
    console.log('name of Neptune\'s moon: ',solarSystem[7].moons[1]);
    console.log("*****************************************************************");


    // 3. Add a new moon called "Endor" to Venus' moons array.
    solarSystem[1].moons.push("Endor");
    console.log('Added a new moon called \"Endor\" to Venus\' moons array: ',solarSystem[1]);
    console.log("*****************************************************************");
    ...
    console.log('Added a Pluto object to the solarSystem : ',solarSystem[8])
    console.log("*****************************************************************");
    ...
    console.log('Add a new key-value pair,diameter to the the Earth object : ',solarSystem[2]);
    console.log("*****************************************************************");

    // 6. Change Mercury's ringSystem boolean to true.
    solarSystem[0].ringSystem=true;
    console.log('Changed Mercury\'s ringSystem boolean to true :',solarSystem[0])
    console.log("*****************************************************************");
    
    // 7. Change Uranus' moon "Umbriel" to "Oberon"
    console.log('Changed Uranus\' moon \"Umbriel\" to \"Oberon\"');
  ...
  console.log('objects that have a ringSystem as true are :')
    ...
    const sum =Number(system.jupiter.satellites) + Number(system.saturn.satellites) + Number(system.uranus.satellites) + Number(system.neptune.satellites)
    console.log('the sum of the number of satellites of Jupiter, Saturn, Uranus, and Neptune:',sum);
    console.log("*****************************************************************")
...
system.mercury.radiusp = system.mercury.radiuse
    ...
    console.log('If Mercury\'s radiusp is a string, changed the value to be the same as its radiuse value. ');
    console.log("*****************************************************************")
    // 5. Console.log Mercury's radiusp (should be 2439, not 'same').
    console.log('Mercurys radiusp:',system.mercury.radiusp);
    console.log("*****************************************************************")
    ...
    console.log('jupiters momentum :',jupiterMomentum);
    const plutoMomentum = system.pluto.velocity * system.pluto.mass
    console.log('Plutos momentum : ',plutoMomentum);
    console.log('difference between Jupiters momentum and Plutos momentum:',jupiterMomentum-plutoMomentum)